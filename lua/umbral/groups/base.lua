...
function M.get(c, opts)
  ...
  return {
    ...
    Conceal                     = { fg = c.selection_bg}, -- placeholder characters substituted for concealed text (see 'conceallevel')
    ...
    FloatTitle                  = { fg = c.magenta, bg = c.bg_float },
    ...
    StatusLine                  = { fg = c.cyan, bg = c.bg_statusline }, -- status line of current window
    ...
    Operator                    = { fg = c.bright_blue}, -- "sizeof", "+", "*", etc.
