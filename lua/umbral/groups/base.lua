...
function M.get(c, opts)
  ...
  return {
    ...
    VertSplit                   = { fg = c.blue}, -- the column separating vertically split windows
    ...
    MatchParen                  = { fg = c.bright_magenta, bold = true }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
    ...
    NormalFloat                 = { fg = c.yellow,  bg = c.bg_float }, -- Normal text in floating windows.
    FloatBorder                 = { fg = c.magenta, bg = c.bg_float },
    FloatTitle                  = { fg = c.red, bg = c.bg_float },
    Pmenu                       = { bg = c.bg_popup, fg = c.fg }, -- Popup menu: normal item.
    PmenuMatch                  = { bg = c.bg_popup, fg = c.bright_magenta}, -- Popup menu: Matched text in normal item.
    ...
    Search                      = { bg = c.green, fg = c.fg }, -- Last search pattern highlighting (see 'hlsearch').  Also used for similar items that need to stand out.
    IncSearch                   = { bg = c.bright_blue, fg = c.black }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
    CurSearch                   =  "IncSearch",
    ...
    StatusLineNC                = { bg = c.bg_statusline, fg = c.fg_gutter}, -- status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
    ...
    Character                   = { fg = c.bright_green}, --  a character constant: 'c', '\n'
